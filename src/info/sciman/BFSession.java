...
public class BFSession {
    ...
    // Error messages
    private static final String ERROR_UNMATCHED = "Error parsing input BF: Unbalanced bracket at col &d";
    ...
    public byte getTapeValue(int pos) {
        if (pos > 0 && pos < TAPE_LENGTH) {
            ...
            throw new IndexOutOfBoundsException(pos + " is out of the bounds of the BF tape [0,"+TAPE_LENGTH+")");
        }
    }
